...
#cluster/kubectl.sh apply -f bigip-node-10.169.72.43.yaml
cluster/kubectl.sh apply -f bigip-node-10.169.72.36.yaml
cluster/kubectl.sh apply -f bigip-node-10.169.72.38.yaml
#cluster/kubectl.sh apply -f f5-kctlr-bigip-node-10.169.72.36.yaml
...
#deploy bigip cc
#cluster/kubectl.sh apply  -f cc-cluster.yaml -n kube-system
#cluster/kubectl.sh apply  -f f5-k8s-bigip-ctrl-cluster-bigip-10.3.72.34.yaml -n kube-system
#cluster/kubectl.sh apply  -f f5-k8s-bigip-ctrl-cluster-bigip-10.3.72.36.yaml -n kube-system
